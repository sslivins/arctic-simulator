...
static void setCommonDefaults() {
    // Typical parameters
    s_holding[COOLING_SETPOINT - HOLDING_BASE]    = 70;   // 7.0°C
    s_holding[HEATING_SETPOINT - HOLDING_BASE]    = 450;  // 45.0°C
    s_holding[HOT_WATER_SETPOINT - HOLDING_BASE]  = 550;  // 55.0°C
    s_holding[COOLING_DELTA_T - HOLDING_BASE]     = 50;   // 5.0°C
    s_holding[HEATING_DELTA_T - HOLDING_BASE]     = 50;   // 5.0°C
    s_holding[HOT_WATER_DELTA_T - HOLDING_BASE]   = 50;   // 5.0°C
    s_holding[FAN_COIL_HEATING_DT - HOLDING_BASE] = 50;   // 5.0°C

    // Common sensor readings
    s_input[AC_VOLTAGE - INPUT_BASE]   = 230;
    s_input[DC_VOLTAGE - INPUT_BASE]   = 3200;  // 320.0V (÷10)
...
void loadPreset(Preset preset) {
    ...
    case Preset::IDLE:
        ...
        s_input[OUTDOOR_AMBIENT_TEMP - INPUT_BASE] = 200;  // 20.0°C
        s_input[INLET_WATER_TEMP - INPUT_BASE]     = 250;  // 25.0°C
        s_input[OUTLET_WATER_TEMP - INPUT_BASE]    = 250;  // 25.0°C
        s_input[WATER_TANK_TEMP - INPUT_BASE]      = 450;  // 45.0°C
        break;
    ...
    case Preset::HEATING:
        ...
        s_holding[HEATING_SETPOINT - HOLDING_BASE] = 450;

        s_input[OUTDOOR_AMBIENT_TEMP - INPUT_BASE] = 50;   // 5.0°C
        s_input[INLET_WATER_TEMP - INPUT_BASE]     = 350;  // 35.0°C
        s_input[OUTLET_WATER_TEMP - INPUT_BASE]    = 420;  // 42.0°C
        s_input[DISCHARGE_TEMP - INPUT_BASE]       = 750;  // 75.0°C
        s_input[SUCTION_TEMP - INPUT_BASE]         = 30;   // 3.0°C
        s_input[OUTDOOR_COIL_TEMP - INPUT_BASE]    = 20;   // 2.0°C
        s_input[COMPRESSOR_FREQ - INPUT_BASE]      = 55;   // 55 Hz
        s_input[FAN_SPEED - INPUT_BASE]            = 600;  // 600 RPM
        s_input[AC_CURRENT - INPUT_BASE]           = 8;    // 8A
        s_input[PRIMARY_EEV - INPUT_BASE]          = 200;  // 200 steps
        s_input[HIGH_PRESSURE - INPUT_BASE]        = 250;  // 2.50 MPa
        s_input[LOW_PRESSURE - INPUT_BASE]         = 80;   // 0.80 MPa
        s_input[IPM_TEMP - INPUT_BASE]             = 450;  // 45.0°C
    ...
    case Preset::COOLING:
        ...
        s_holding[COOLING_SETPOINT - HOLDING_BASE] = 70;

        s_input[OUTDOOR_AMBIENT_TEMP - INPUT_BASE] = 350;  // 35.0°C
        s_input[INLET_WATER_TEMP - INPUT_BASE]     = 120;  // 12.0°C
        s_input[OUTLET_WATER_TEMP - INPUT_BASE]    = 80;   // 8.0°C
        s_input[DISCHARGE_TEMP - INPUT_BASE]       = 650;  // 65.0°C
        s_input[SUCTION_TEMP - INPUT_BASE]         = 50;   // 5.0°C
        s_input[OUTDOOR_COIL_TEMP - INPUT_BASE]    = 500;  // 50.0°C
        ...
        s_input[HIGH_PRESSURE - INPUT_BASE]        = 300;
        s_input[LOW_PRESSURE - INPUT_BASE]         = 60;
        s_input[IPM_TEMP - INPUT_BASE]             = 500;
    ...
    case Preset::HOT_WATER:
        ...
        s_holding[HOT_WATER_SETPOINT - HOLDING_BASE] = 550;

        s_input[OUTDOOR_AMBIENT_TEMP - INPUT_BASE] = 200;
        s_input[INLET_WATER_TEMP - INPUT_BASE]     = 400;
        s_input[OUTLET_WATER_TEMP - INPUT_BASE]    = 480;
        s_input[WATER_TANK_TEMP - INPUT_BASE]      = 420;
        s_input[DISCHARGE_TEMP - INPUT_BASE]       = 850;
        s_input[SUCTION_TEMP - INPUT_BASE]         = 80;
        s_input[COMPRESSOR_FREQ - INPUT_BASE]      = 70;
        s_input[FAN_SPEED - INPUT_BASE]            = 500;
        s_input[AC_CURRENT - INPUT_BASE]           = 12;
        s_input[HIGH_PRESSURE - INPUT_BASE]        = 350;
    ...
    case Preset::DEFROST:
        ...
        s_input[OUTDOOR_AMBIENT_TEMP - INPUT_BASE] = 620;   // -2.0°C (offset 60 + value)
        s_input[INLET_WATER_TEMP - INPUT_BASE]     = 300;
        s_input[OUTLET_WATER_TEMP - INPUT_BASE]    = 280;
        s_input[OUTDOOR_COIL_TEMP - INPUT_BASE]    = 610;   // -5.0°C
        s_input[DISCHARGE_TEMP - INPUT_BASE]       = 500;
